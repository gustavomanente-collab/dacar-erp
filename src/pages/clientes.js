...
// Exportar a Sheets
    window.exportarCtaCteSheets = async (id) => {
      ...
      const CTC_URL = `https://script.google.com/macros/s/AKfycbz-aG2ItT4ARAu6sWOloRQVTXkrnhvVlwNtSShU13TKr4p-4102KwFlf2kkgFdgV8WC6g/exec?action=ctacte&clienteId=${id}`
